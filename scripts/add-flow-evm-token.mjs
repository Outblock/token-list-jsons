...
const fixesEndpoints = {
  mainnet:
    'https://raw.githubusercontent.com/fixes-world/token-list-jsons/refs/heads/main/jsons/mainnet',
  testnet:
    'https://raw.githubusercontent.com/fixes-world/token-list-jsons/refs/heads/main/jsons/testnet',
}
...
const main = async () => {
  ...
  const currentTokens = await loadOutblocTokenList(
    `../jsons/${network}/evm/default.json`,
  )
  ...
  fs.writeFileSync(
    path.resolve(__dirname, `../jsons/${network}/evm/default.json`),
